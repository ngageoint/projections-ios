...
class PROJSwiftReadmeTest: XCTestCase{
    ...
    func testTransform(){
        ...
        XCTAssertEqual(1.0, transformed.longitude, accuracy: 0.0000000000001)
        XCTAssertEqual(1.0, transformed.latitude, accuracy: 0.0000000000001)
    }
    ...
    func testTransform(_ coordinate: CLLocationCoordinate2D) -> CLLocationCoordinate2D{
        ...
        // Use the unused variables to silence the warnings
        print(projection3)
        print(projection4)
